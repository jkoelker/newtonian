...
class Subnet(Base, IsHazTenant, IsHazTags):
    ...
    allow_requested_ip = sa.Column(sa.Boolean, default=True)
...
class Ip(Base, IsHazTenant, IsHazTags):
    ...
    def deallocate(self):
        self.deallocated_at = datetime.datetime.utcnow()
